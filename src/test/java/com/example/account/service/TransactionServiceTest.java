...
class TransactionServiceTest {
    ...
    @Test
    @DisplayName("거래금액이 잔액보다 큰경우")
    void exeed_UseBalance() {
        //given
        AccountUser user = AccountUser.builder()
                .id(12L)
                .name("Pobi")
    ...
    void cancelTransaction_AccountNotFound(){
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,() -> transactionService.cancelBalance("transaction","1000000000",1000L));
    ...
    void cancelTransaction_TransactionNotFound(){
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,
                () -> transactionService.cancelBalance("transid","1000000000",1000L));
    ...
    void cancelTransaction_TransactionAccountUnMatch(){
        ...
        //when
        AccountException exception = assertThrows(AccountException.class,() ->
                transactionService.cancelBalance("transaction","1000000000",CANCEL_AMOUNT));
    ...
    @Test
    @DisplayName("금액이 다름 - 잔액 사용 취소 실패")
    ...
    @Test
    @DisplayName("취소는 1년까지가능- 잔액 사용 취소 실패")
